...
class add_notifi(private val context: Context, var notifi:List<Notifi_class>) :RecyclerView.Adapter<add_notifi.PostViewHolder>() {


    var onItemClick: ((Notifi_class) -> Unit)? = null
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int) {
        val currentPost = notifi[position]
        holder.apply {
